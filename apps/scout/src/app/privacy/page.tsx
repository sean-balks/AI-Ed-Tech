...
export const metadata = {
  ...
  description: "How Scout and Superday LLC collect, use, and protect your information.",
};
    ...
    <div className="min-h-screen bg-white font-sans">
      ...
      <main className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="space-y-10 text-gray-700 leading-relaxed">
          ...
          <p className="text-sm">
            This Privacy Policy describes how Superday LLC (&ldquo;Superday,&rdquo; &ldquo;we,&rdquo; &ldquo;us,&rdquo; or &ldquo;our&rdquo;) collects, uses, and shares information when you use <strong>Scout</strong> (the &ldquo;Service&rdquo;). By using the Service, you agree to the practices described below.
          </p>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-1 text-sm">
              ...
              <li><strong>Stripe</strong> — payment processing, subject to <a href="https://stripe.com/privacy" className="text-teal-600 underline" target="_blank" rel="noopener noreferrer">Stripe&apos;s Privacy Policy</a>.</li>
              <li><strong>Google</strong> — analytics via GA4, subject to <a href="https://policies.google.com/privacy" className="text-teal-600 underline" target="_blank" rel="noopener noreferrer">Google&apos;s Privacy Policy</a>.</li>
              <li><strong>Meta</strong> — advertising and analytics via Meta Pixel, subject to <a href="https://www.facebook.com/privacy/policy/" className="text-teal-600 underline" target="_blank" rel="noopener noreferrer">Meta&apos;s Privacy Policy</a>.</li>
          ...
          <section>
            ...
            <p className="text-sm mt-3">To exercise any of these rights, contact us at <a href="mailto:superday.outreach@gmail.com" className="text-teal-600 underline">superday.outreach@gmail.com</a>.</p>
          </section>
          ...
          <section>
            ...
            <p className="text-sm mb-3">
              Scout is an educational support tool and AI-assistance platform. Superday LLC makes no guarantee, representation, or warranty — express or implied — that use of the Service will result in any improvement in standardized test scores (including MCAT scores), academic performance, admission to any medical school or other educational program, or employment opportunities. See our <a href="/terms" className="text-teal-600 underline">Terms of Service</a> for the full disclaimer.
            </p>
          </section>
