...
export const metadata = {
  ...
  description: "Terms governing your use of Lumio, operated by Superday LLC.",
};
    ...
    <div className="min-h-screen bg-white font-sans">
      ...
      <main className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="space-y-10 text-gray-700 leading-relaxed">
          ...
          <p className="text-sm">
            These Terms of Service (&ldquo;Terms&rdquo;) govern your access to and use of <strong>Lumio</strong> (the &ldquo;Service&rdquo;), operated by Superday LLC (&ldquo;Superday,&rdquo; &ldquo;we,&rdquo; &ldquo;us,&rdquo; or &ldquo;our&rdquo;). By accessing or using the Service, you agree to be bound by these Terms. If you do not agree, do not use the Service.
          </p>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-1 text-sm">
              ...
              <li>Notify us immediately at <a href="mailto:superday.outreach@gmail.com" className="text-blue-600 underline">superday.outreach@gmail.com</a> if you suspect unauthorized access to your account.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="text-sm mb-3">
              Lumio is offered on a subscription basis at <strong>$19/month</strong>. By subscribing, you authorize Superday to charge your payment method on a recurring monthly basis until you cancel.
            </p>
            <ul className="list-disc pl-6 space-y-1 text-sm">
              ...
              <li>Payment processing is handled by Stripe. By providing payment information, you also agree to <a href="https://stripe.com/legal" className="text-blue-600 underline" target="_blank" rel="noopener noreferrer">Stripe&apos;s Terms of Service</a>.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="text-sm mb-4 font-medium text-gray-800">
              Lumio is an educational support tool and AI-assistance platform. It is not a licensed tutoring service, school, or accredited educational institution.
            </p>
